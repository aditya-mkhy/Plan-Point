...
class Email:
    def __init__(self):
        ...
        self.port = 587
        self.host = settings.APP_EMAIL
        self.password = settings.APP_PASSWD
            ...
            <div
                ...
                <div style="text-align: center;justify-content: center;align-items: center;">
                    ...
                    <div style="margin-top: 50px;">
                        <a href="{dafultname.myIP}verified/{token}"
                    ...
                    <div>
                        <p
                            ...
                            Should you have any questions or need any help, please contact us at <a
                                href="{dafultname.myIP}contacts">{dafultname.myIP}contacts</a></p>
            ...
            <div
                ...
                <div style="text-align: center;justify-content: center;align-items: center;">
                    ...
                    <div>
                        <p
                            style="padding: 0px 20px 0px 20px ; text-align: center; font-size: 16px; justify-content: center; align-items: center; color: #5c5b5b; line-height: 1.8; display: block; font-style: normal; font-family: 'Source Sans Pro',-apple-system,BlinkMacSystemFont,'Segoe UI','Helvetica Neue',Arial,sans-serif;">
                            If you didn’t request a login link or a password reset, you can ignore this message and <a style="text-decoration: none;" href="{dafultname.myIP}contacts">learn more about why you may have received it.</a></p>
                    </div>
                    <hr style="margin-top: 70px; background-color: #a1a1a1;  padding: 1px 0px 0px 0px; border: none;">
                    <div>
                        <p
...
if __name__ == "__main__":
    mail = Email()
    page = mail.send_otp("User", "768674")
    mail.send("mahadevadityamukhiya@gmail.com", "Verify Email", page)
