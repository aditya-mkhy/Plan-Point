...
SECRET_KEY = 'django-insecure-=8=-*arzqaz*837$a(sudxx4=4@8_wk8fm+2dl$5y5sctq(lgi'


# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['darkstartech.pythonanywhere.com', 'localhost']
...
AUTH_USER_MODEL = 'Seating.MyUser'
...
# email id and App Password for sending OTP
